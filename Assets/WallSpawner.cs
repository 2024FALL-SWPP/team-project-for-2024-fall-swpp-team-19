...
public class WallSpawner : MonoBehaviour
{
    ...
    public Vector3 spawnPosition1 = new Vector3(500, 0, 345);
    ...
    private IEnumerator SpawnAndDestroyWall()
    {
        ...
        {
            // 벽 생성
            GameObject wall1 = Instantiate(wallPrefab, spawnPosition1, Quaternion.identity);
            GameObject wall2 = Instantiate(wallPrefab, spawnPosition2, Quaternion.identity);
            GameObject wall3 = Instantiate(wallPrefab, spawnPosition3, rotation);
            GameObject wall4 = Instantiate(wallPrefab, spawnPosition4, rotation);
